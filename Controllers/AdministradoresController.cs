...
namespace ZONAUTO.Controllers
{
    ...
    public class AdministradoresController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var totalAdministradores = await _context.Administradores.CountAsync();
            ...
            var ultimasOfertas = await _context.Ofertas
                .OrderByDescending(o => o.OfertaId)
                .Take(5)
                .ToListAsync();

            var publicacionesPorMes = await GetPublicacionesPorMes();
            ...
            ViewBag.UltimasOfertas = ultimasOfertas;
            ViewBag.PublicacionesPorMes = publicacionesPorMes; // Esto será una lista de objetos { Mes, Cantidad }
